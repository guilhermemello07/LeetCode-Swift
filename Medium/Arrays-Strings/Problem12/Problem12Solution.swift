...
var num1 = 1239
print(intToRoman(num1)) // MCCXXXIX

var num2 = 3
print(intToRoman(num2)) //III

var num3 = 58
print(intToRoman(num3)) //LVIII

var num4 = 1994
print(intToRoman(num4)) // MCMXCIV
